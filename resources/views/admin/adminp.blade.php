...
<a href="{{route('adminp')}}"><em class="fa fa-times-circle">&nbsp;</em>No ,Cancelar</a></li>
        ...
        <table class="scroll" class="table table-hover">
          <tr>
             ...
             <tr>
                  ...
                  <td><td> <img src="{{ asset('archivos/'. $productos->fotop)}}"  width="80" height="100" alt="Product Image"></td></td>
